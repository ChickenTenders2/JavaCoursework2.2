...
// This class provides a concrete implementation of the abstract Circular queue type, implemented using an array.
...
public class MyArrayQueue {
    ...
    public void enqueue(Object theElement) {
        ...
        int availableIndex = (front + numElements) % queue.length;
        queue[availableIndex] = theElement;
        numElements++;
    }
    ...
    public String toString() {
        ...
        sb.append("]");
        return sb.toString();
        // return Arrays.toString(queue); // Replace this section as it doesn't order arrangements correctly
    }
